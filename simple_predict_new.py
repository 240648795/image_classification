...
if __name__ == '__main__':
    ...
    predictions = []
    predictions.append(get_prediction(r'./data/test_image/sisha_left_0.jpg', predict_model, predict_model_details))
    predictions.append(get_prediction(r'./data/test_image/shashi_left_5.jpg', predict_model, predict_model_details))
    predictions.append(get_prediction(r'./data/test_image/sisha_left_30.jpg', predict_model, predict_model_details))
    print(predictions)

    # 这是看第一层卷积后的图
    layer_output_show(r'./data/test_image/huangtu_left_45.jpg', 4, predict_model, predict_model_details)
    pass
